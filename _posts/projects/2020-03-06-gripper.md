...
![Chassis cad](/assets/img/drone.png){:height="30%" width="30%"}
![Chassis cad](/assets/img/final girpper.png){:height="30%" width="30%"}
![Chassis cad](/assets/img/gripper sketch.png){:height="30%" width="30%"}
![Chassis cad](/assets/img/positional.png){:height="30%" width="30%"}
![Chassis cad](/assets/img/acceleration.png){:height="30%" width="30%"}
