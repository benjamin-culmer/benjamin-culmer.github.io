...
## Highlights
- I designed a gripping mechanism to pick up microplates from a drone within a 5mm sphere of uncertainty
- I designed a test stand to simulate drone flight in order to test our gipping mechanism
- I created custom parts in SolidWorks(CAD), manufactured parts by hand, and tested and improved upon failures
- I presented progress of our gripping mechanism to a board of advisors and our sponsoring company
...
![Chassis cad](/assets/img/drone.png){:height="50%" width="50%"}
...
![Chassis cad](/assets/img/final girpper.png){:height="50%" width="50%"}
{: style="text-align: center;"}
![Chassis cad](/assets/img/gripper sketch.png){:height="50%" width="50%"}
{: style="text-align: center;"}
![Chassis cad](/assets/img/positional.png){:height="50%" width="50%"}
{: style="text-align: center;"}
![Chassis cad](/assets/img/acceleration.png){:height="50%" width="50%"}
{: style="text-align: center;"}
