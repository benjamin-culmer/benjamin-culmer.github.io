...
![Chassis cad](/assets/img/Penn Scanner.JPG){:height="50%" width="50%"}{: style="text-align: center;"}
...
![Chassis cad](/assets/img/Module.png){:height="50%" width="50%"}{: style="text-align: center;"}
![Chassis cad](/assets/img/stir bar.PNG){:height="50%" width="50%"}{: style="text-align: center;"}
